...
Public Class EmpleadoList
  ...
  Public Shared Function ObtenerLista(ByVal _OperadorDatos As OperadorDatos, Optional ByVal _SoloActivos As Boolean = False, Optional ByVal _Nombre As String = "", Optional ByVal _Codigo As Integer = 0, Optional ByVal _Cedula As String = "", Optional ByVal _Edad As Integer = 0, Optional ByVal _Mayorque As Boolean = True) As EmpleadoList
    ...
    With _OperadorDatos
      ...
      If _SoloActivos Then
        .AgregarParametro("@Emplea_Visible", _SoloActivos)
      End If
      If _Codigo > 0 Then
  ...
  Public Shared Function ObtenerLista(ByVal _OperadorDatos As OperadorDatos, ByVal _TipoEmpleado As WWTSParametroDet, Optional ByVal _SoloActivos As Boolean = False, Optional ByVal _Nombre As String = "") As EmpleadoList
    Dim oResult As EmpleadoList = New EmpleadoList
    Dim bReturn As Boolean
    Dim ds As DataTable = Nothing
    With _OperadorDatos
