...
Public Class FrmReporteDepreciacion
  Private mDepreciacion As Depreciacion = Nothing
  Public Property Depreciacion As Depreciacion
    Get
      Return mDepreciacion
    End Get
  ...
  Sub llenar_datos()
    Try
      Dim info As New crpDepreciacion
      ...
      info.SetDataSource(clsReporteActivo.RetornarDepreciacionDS(mDepreciacion))
