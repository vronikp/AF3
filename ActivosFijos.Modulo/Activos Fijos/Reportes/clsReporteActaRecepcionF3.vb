...
Public Class clsReporteActaRecepcionF3
    Public Shared Function RetornarReporteActaRecepcionDS(_Custodio As Empleado, _PeriodoInventario As WWTSParametroDet, _Ubicacion As WWTSParametroDet, _SoloInventariados As Boolean) As dsActaConstatacionF3
