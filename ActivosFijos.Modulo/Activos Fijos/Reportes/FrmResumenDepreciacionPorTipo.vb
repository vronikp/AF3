...
Public Class FrmResumenDepreciacionPorTipo
  Sub llenar_datos()
    If cbotipodepreciacion.ParametroDet Is Nothing Then
      Exit Sub
    End If
    Try
      Dim info As New crpResumenDepreciacionPorTipo
      info.DataDefinition.FormulaFields("cortado_al").Text = String.Format("'{0}'", Me.DateTimePicker1.Value.ToString("yyyy/MM"))
      ...
      info.SetDataSource(clsResumenDepreciacionPorTipo.RetornarResumenDepreciacionPorTipoDS(Me.cbotipodepreciacion.ParametroDet, Me.DateTimePicker1.Value.Year, Me.DateTimePicker1.Value.Month))
