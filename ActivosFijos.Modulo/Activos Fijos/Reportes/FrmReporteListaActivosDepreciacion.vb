...
Public Class FrmReporteListaActivosDepreciacion
  Private mdsReporteActivoDepreciacion As dsReporteActivoDepreciacion
  Public Property dsReporteActivoDepreciacion As dsReporteActivoDepreciacion
    Get
      Return mdsReporteActivoDepreciacion
    End Get
    Set(value As dsReporteActivoDepreciacion)
      mdsReporteActivoDepreciacion = value
      llenar_datos()
    End Set
  End Property
    ...
    Try
      ...
      Select Case ListaActivosOrden
        Case EnumListaActivosOrden.GrupoTipoClase
          info = New crpListaActivosDepreciacionporGrupoTipoClase
        Case EnumListaActivosOrden.Custodio
          info = New crpListaActivosDepreciacionporCustodio
        Case EnumListaActivosOrden.Ubicacion
          info = New crpListaActivosDepreciacionporUbicacion
      End Select
      ...
      info.SetDataSource(dsReporteActivoDepreciacion)
